...
type KafkaData struct {
	...
	ReportTimeHasClock *bool  `json:"report_time_has_clock,omitempty"`
	ConsumptionTime    string `json:"consumption_time"`
	EventName          string `json:"event_name"`
	Offset             int64  `json:"offset"`
}

func (d *KafkaData) GetTableName() (tableName string) {
	buff := bytes.Buffer{}
	...
	buff.WriteString(d.TableId)
	tableName = buff.String()
	return
}

func (d *KafkaData) GetReportTypeErr() (eventType string) {
...
type EventData struct {
	...
	XwlCountry      string                 `json:"xwl_country"`
	XwlISP          string                 `json:"xwl_isp"`
	XwlASN          string                 `json:"xwl_asn"`
