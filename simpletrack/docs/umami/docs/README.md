...
3. 然后按目标选择：
   ...
   - 想做营销与增长：看 `17` 到 `19`
   - 想理解工作台、协作和扩展：看 `20`
4. 如果要进入实现对照，先看 [21-源代码实现参考](./21-源代码实现参考.md)，再进入 [源码实现参考章节索引](./源码实现参考/索引.md)
...
| 我想知道 `website_event`、`event_data`、`session_data` 到底怎么分层 | [事件与属性存储模型源码分析](./事件与属性存储模型源码分析.md) | `02-从采集到事件分析` |
...
| 我想把 Umami 和 `analytics-core`、`xwl_bi`、Litlyx 放在一起比较 | [../../事件与属性存储方案对比.md](../../事件与属性存储方案对比.md) | `07-SimpleTrack能力优先级` |
...
- [事件与属性存储模型源码分析](./事件与属性存储模型源码分析.md)
- [源码实现参考章节索引](./源码实现参考/索引.md)
- [源码实现参考总览](./源码实现参考/README.md)
- [源码实现参考 Q&A](./源码实现参考/Q&A/README.md)
...
- `../../../references/umami/`、[21-源代码实现参考](./21-源代码实现参考.md) 和 [源码实现参考章节索引](./源码实现参考/索引.md) 是“官方源码实现参考层”
