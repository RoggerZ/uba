...
- `simpletrack/docs/umami/snapshots/phase-07-traffic-and-behavior-insights/P07-S08-filter-segment-applied.png`：已保存 Segment 应用到 Compare 后，页面显示切片后的 1 visitor、1 visit、5 views。
...
- 本轮已验证保存对象、配置态和应用后结果态；列表页本身不直接展示人数，但应用到分析页后可以触发指标重算。
