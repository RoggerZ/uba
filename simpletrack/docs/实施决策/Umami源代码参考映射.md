...
| tracker auto pageview、custom event、identify | P1-004 | P1 已吸收为无依赖浏览器 SDK 和 docs/quickstart，并补齐 opt-in DNT 和 allowlisted UTM/click id；多框架 SDK、CDN 版本化和 performance metrics 后置 | `analytics-core/sdk/browser/tracker.js` -> `collect.Request` 协议 |
