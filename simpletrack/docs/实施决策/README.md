...
本节版本标记：`analytics-core` commit `f84024a`；`analytics-service` commit `0248a80`；`simpletrack-saas` commit `e69cea6`；父仓本轮文档 commit `76589df`。
