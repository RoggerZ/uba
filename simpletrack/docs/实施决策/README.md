...
1. 继续推进 P1.5-001：把 `simpletrack-anaysitics-service` 的 `/v1/properties` 接入 `simpletrack-saas` Events filter builder，让筛选字段来自 source-scoped property catalog，而不是手工输入或硬编码示例。
