...
本节版本标记：`analytics-core` commit `1ea78f3`；`analytics-service` commit `0248a80`；`simpletrack-saas` commit `e69cea6`；父仓本轮文档 commit `1a81b75`。
