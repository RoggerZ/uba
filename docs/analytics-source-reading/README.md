...
- 当前第六步记录真实 ClickHouse reader benchmark 基线：2026-05-08 在本机 `clickhouse/clickhouse-server:25.3` 上执行 `BenchmarkEventReaderClickHouseExecution`，low realtime 约 8.6-10.4ms/op，medium scalar events 约 8.6-9.7ms/op，high property events 约 15.2-16.3ms/op；详见 [read-side-benchmark-baseline.md](read-side-benchmark-baseline.md)。
