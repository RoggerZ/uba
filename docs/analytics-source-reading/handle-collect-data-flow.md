...
>
> 重点入口：`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:175` 的 `handleCollect`。
>
...
| `src/analytics-core` | `7c296670842d` | `git status --short` 仅显示未跟踪 `.idea/`，本文引用的源码文件与 `HEAD` 一致 |
| `src/simpletrack-saas` | `bce33354ae27` | 当前存在 `packages/database/prisma/zod/index.ts` 未提交改动和未跟踪 `.omx/`；本文引用的 runtime-source 相关源码文件与 `HEAD` 一致 |
...
flowchart LR
    ...
    Session --> Visit["VisitResolverStage<br/>visit_id 派生"]
    Visit --> EventBus["eventbus.EventBus"]
...
位置：`仓库: simpletrack-saas, commit: bce33354ae27, file: packages/api/modules/simpletrack/runtime-source.ts:55-170`
...
位置：`仓库: simpletrack-saas, commit: bce33354ae27, file: packages/api/index.ts:33-34`
...
位置：`仓库: simpletrack-saas, commit: bce33354ae27, file: apps/saas/app/api/[[...rest]]/route.ts:1-7`
...
| `visit_salt` | 派生 canonical `visit_id` |
| `visit_window_seconds` | canonical `visit_id` 的时间桶大小 |
...
│  ├─ session.go                       # session_id 与 visit_id 派生
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:32-109`
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:308-350`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:308-313`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:314-320`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:321-325`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:326-336`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:337-342`
...
代码位置：`仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:343-350`
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:64-84`、`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:155-169`
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/resolver.go:110-114`、`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/http_resolver.go:124-155`
...
| `VisitSalt` | `string` | 派生 `visit_id` 的盐 |
| `VisitWindow` | `time.Duration` | `visit_id` 的时间桶 |
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/http_resolver.go:158-174`
...
核心入口：`仓库: analytics-core, commit: 7c296670842d, file: collect/handler.go:61`
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:358-377`
...
位置：`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/http_resolver.go:191-235`
...
flowchart TD
    ...
    SES --> VIS["VisitResolverStage<br/>缺 visit_id 时派生"]
    VIS --> ENV4["EventEnvelope<br/>最终发布消息"]
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:68` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:64-84` |
| 类型 | `*fiber.App` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:155-169` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:404-406` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:188`、`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:358-377` |
| 类型 | `string` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:197`、`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:409-411` |
| 类型 | `string` |
| 用途 | 浏览器来源校验 |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:201-209` |
| 类型 | `collect.Request` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:380-395`、`仓库: analytics-core, commit: 7c296670842d, file: collect/client.go:9-19` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:243-301` |
| 类型 | `[]collect.Stage` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/request.go:57-71` |
| 类型 | `collect.Request` |
...
| 事件语义 | `EventName`、`DistinctID`、`SessionID`、`VisitID`、`EventTime` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/handler.go:66` |
| 类型 | `time.Time` |
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-core, commit: 7c296670842d, file: contracts/event.go:5-20` |
...
- `VisitResolverStage` 可能填充 `VisitID`。
...
| 项 | 内容 |
| --- | --- |
| 定义位置 | `仓库: analytics-core, commit: 7c296670842d, file: eventbus/eventbus.go:27-32`、`仓库: analytics-core, commit: 7c296670842d, file: eventbus/redisstream/redisstream.go:58-72` |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:177-183` |
| --- | --- |
| 输入数据点 | HTTP body |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:188`、`仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:358-377` |
| --- | --- |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:189`、`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/http_resolver.go:125-155` |
| --- | --- |
| 输入数据点 | `writeKey` |
| 输出数据点 | `SourceConfig` |
| 失败结果 | 401 / 403 / 500 |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:194-198`、`仓库: analytics-service, commit: 09656b6, file: internal/controlplane/resolver.go:66-78` |
| --- | --- |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:201-209` |
| --- | --- |
...
| 位置 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:243-301` |
| --- | --- |
| 输入数据点 | `SourceConfig` |
| 输出数据点 | `[]collect.Stage` |
...
- `VisitSalt`、`VisitWindow` 进入 VisitResolver，确保 `visit_id` 在发布前确定。
- 配置错误属于服务端错误，因为 source config 是可信控制面数据。

#### PA-07 Normalize

| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/handler.go:66-71`、`仓库: analytics-core, commit: 7c296670842d, file: collect/request.go:93-161` |
| --- | --- |
...
- 字符串字段 trim。
- `id`、`tenant_id`、`project_id`、`source_id`、`distinct_id`、`session_id`、`visit_id` 用 `identifierPattern` 校验。
...
| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/traffic_filter.go:76-90` |
| --- | --- |
...
| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/enrichment.go:40-58` |
| --- | --- |
...
| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/session.go:44-72` |
| --- | --- |
...
#### PA-11 VisitResolverStage

| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/session.go:82-131` |
| --- | --- |
| 输入数据点 | `EventEnvelope`、`VisitSalt`、`VisitWindow` |
| 输出数据点 | 可能填充 `VisitID` 的 `EventEnvelope` |
| 失败结果 | 派生出的 `visit_id` 校验失败时返回 error |

变化说明：

- 如果客户端已经传了 `visit_id`，保持不变。
- 如果缺失，则按 `tenant/project/source/distinct_id/session_id/event_time_bucket` 派生。
- 这个阶段在 SessionResolver 后执行，所以会使用最终写入的 `session_id`。
- 派生结果格式是 `vis_` + 32 位 digest 片段，后续 Realtime / Events 直接读取该存储字段。

#### PA-12 EventBus 发布

| 位置 | `仓库: analytics-core, commit: 7c296670842d, file: collect/handler.go:81`、`仓库: analytics-core, commit: 7c296670842d, file: eventbus/redisstream/redisstream.go:58-72` |
| --- | --- |
...
| VisitResolver | 不再使用 | visit salt/window 已固化到 stage | 作为 StageInput | 不再使用 | VisitID 可能增加 | 否 |
...
| `visit_id` | `VisitID` | 可选 | 缺失时由服务端派生；长期分析查询直接读取 |
...
- `VisitResolverStage` 需要在 queue 前填好 visit_id，这样 Realtime、Events、Sessions、Funnels、Journeys、Retention 都能直接使用同一份存储字段。
...
| 顺序 | 指定位置 | 发生的动作 | 数据点变化 |
| --- | --- | --- | --- |
| 1 | `仓库: analytics-service, commit: 09656b6, file: internal/runtime/runtime.go:68` | `collectapi.NewApp(Options)` | 把 route path、Resolver、Bus、Now、Swagger、QueryReader 交给 Fiber app |
| 2 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:81` | `h.registerRoutes(app)` | Fiber app 完成 `/collect` 等路由注册 |
| 3 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:156` | `app.Post(h.opts.CollectPath, h.handleCollect)` | `POST /collect` 绑定到 `handleCollect` |
| 4 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:189` | `ResolveSource(ctx, writeKey)` | write key 转成可信 `SourceConfig` |
| 5 | `仓库: analytics-service, commit: 09656b6, file: internal/controlplane/http_resolver.go:125` | `HTTPResolver.ResolveSource` | cache / ETag / control-plane HTTP 查询，返回 source 或错误 |
| 6 | `仓库: analytics-service, commit: 09656b6, file: internal/collectapi/handler.go:241` | `h.stages(source)` | source filter/salt/fingerprint 配置转成 `[]collect.Stage` |
| 7 | `仓库: analytics-core, commit: 7c296670842d, file: collect/handler.go:61` | `collect.Handler.Handle` | `collect.Request` 标准化成 `EventEnvelope`，执行 stages，发布 EventBus |
| 8 | `仓库: analytics-core, commit: 7c296670842d, file: collect/traffic_filter.go:76` | `TrafficFilterStage.Apply` | 根据 UA/IP 过滤 bot 和 internal traffic |
| 9 | `仓库: analytics-core, commit: 7c296670842d, file: collect/session.go:44` | `SessionResolverStage.Apply` | 缺失 `session_id` 时按盐和时间桶派生 |
| 10 | `仓库: analytics-core, commit: 7c296670842d, file: collect/session.go:82` | `VisitResolverStage.Apply` | 缺失 `visit_id` 时按盐、session 和时间桶派生 |
| 11 | `仓库: analytics-core, commit: 7c296670842d, file: collect/enrichment.go:40` | `ClientEnrichmentStage.Apply` | 把 UA/referrer/IP hash 作为 bounded properties 加到 envelope |

实际执行顺序里，stage 顺序是 `traffic_filter -> enrichment -> session -> visit`。上表按你提供的编号列出，但处理链中的 `仓库: analytics-core, commit: 7c296670842d, file: collect/enrichment.go:40` 会在 `仓库: analytics-core, commit: 7c296670842d, file: collect/session.go:44` 前执行；`VisitResolverStage` 会在 session 已经稳定后执行。

## 10. 一句话总结

`handleCollect` 的核心设计是：公开请求只提供事件事实和 write key，真正的租户边界、source 身份、origin 策略、过滤规则和隐私 salt 都来自 control-plane runtime config；随后 `analytics-core` 用框架无关的 `collect.Request` 生成稳定 `EventEnvelope`，在发布前完成过滤、派生属性、session 补全和 canonical visit 补全，最后只有成功进入 EventBus 的事件才返回 accepted。
